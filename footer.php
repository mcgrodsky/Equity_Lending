    ...
    <div class = "push"></div> <!-- empty class for sticky footer -->

    <?php wp_footer(); ?>

    <div class = "footer">
      <div id = "footer">Equity Lending Inc, All Rights Reserved &copy; 2016</div>
    </div>

    <!-- attributions div hidden - need to confirm best practice -->
